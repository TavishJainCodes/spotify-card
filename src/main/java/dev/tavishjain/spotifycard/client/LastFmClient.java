...
public class LastFmClient {
    ...
    public String getInfo(String trackName) {
        RestTemplate restTemplate = new RestTemplate();

        // curl
        // "https://ws.audioscrobbler.com/2.0?method=track.search&track=Kamaal+Hai&api_key=0cc55924034e77d0452f12ae19092d1a&format=json&limit=5"
